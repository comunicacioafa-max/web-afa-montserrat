...
export interface ApiComunicacioComunicacio extends Struct.SingleTypeSchema {
  collectionName: 'comunicacions'
  info: {
    displayName: 'Comunicacio'
    pluralName: 'comunicacions'
    singularName: 'comunicacio'
  }
  options: {
  ...
  attributes: {
    comunicacio: Schema.Attribute.Component<'home.comissio', false> &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::comunicacio.comunicacio'>
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
  }
...
export interface ApiExtraescolarExtraescolar extends Struct.SingleTypeSchema {
  collectionName: 'extraescolars'
  info: {
    displayName: 'Extraescolars'
    pluralName: 'extraescolars'
    singularName: 'extraescolar'
  }
  options: {
    draftAndPublish: true
  }
  attributes: {
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    extraescolar: Schema.Attribute.Component<'home.comissio', false> & Schema.Attribute.Required
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::extraescolar.extraescolar'> & Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
  }
...
export interface ApiFestesFestes extends Struct.SingleTypeSchema {
  collectionName: 'festess'
  info: {
    displayName: 'Festes'
    pluralName: 'festess'
    singularName: 'festes'
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    festes: Schema.Attribute.Component<'home.comissio', false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::festes.festes'> & Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
  }
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    comissions: Schema.Attribute.Component<'home.comissio', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
...
export interface ApiLlibresLlibres extends Struct.SingleTypeSchema {
  collectionName: 'llibress'
  info: {
    displayName: 'Llibres'
    pluralName: 'llibress'
    singularName: 'llibres'
  }
  options: {
    draftAndPublish: true
  }
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    llibres: Schema.Attribute.Component<'home.comissio', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::llibres.llibres'>
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
  }
...
export interface ApiMenjadorMenjador extends Struct.SingleTypeSchema {
  collectionName: 'menjadors'
  info: {
    displayName: 'Menjador'
    pluralName: 'menjadors'
    singularName: 'menjador'
  }
  options: {
    draftAndPublish: true
  }
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menjador.menjador'>
    menjador: Schema.Attribute.Component<'home.comissio', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publisedAt: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false
...
export interface ApiProjectesProjectes extends Struct.SingleTypeSchema {
  collectionName: 'projectess'
  info: {
    displayName: 'Projectes'
    pluralName: 'projectess'
    singularName: 'projectes'
  }
  options: {
    draftAndPublish: true
  }
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::projectes.projectes'>
    projectes: Schema.Attribute.Component<'home.comissio', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
export interface ApiRobaRoba extends Struct.SingleTypeSchema {
  collectionName: 'robas'
  info: {
    displayName: 'Roba'
    pluralName: 'robas'
    singularName: 'roba'
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    locale: Schema.Attribute.String
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::roba.roba'>
    publishedAt: Schema.Attribute.DateTime
    roba: Schema.Attribute.Component<'home.comissio', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::comunicacio.comunicacio': ApiComunicacioComunicacio
      'api::extraescolar.extraescolar': ApiExtraescolarExtraescolar
      'api::festes.festes': ApiFestesFestes
      'api::home.home': ApiHomeHome
      'api::llibres.llibres': ApiLlibresLlibres
      'api::menjador.menjador': ApiMenjadorMenjador
      'api::new.new': ApiNewNew
      'api::projectes.projectes': ApiProjectesProjectes
      'api::roba.roba': ApiRobaRoba
