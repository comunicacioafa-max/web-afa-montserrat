...
export interface ApiComissioComissio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['shared.slider', 'shared.rich-text', 'shared.quote', 'shared.media']> &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::comissio.comissio'>
    publishedAt: Schema.Attribute.DateTime
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    comissions: Schema.Attribute.Component<'comissions.comissio', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
